...
public class KeycloakService {
    ...
    public Mono<TokenResponse> registerUser(String email, String password) {
        return createUserInKeycloak(email, password)
                .then(loginUser(email, password));
    }

    private Mono<Void> createUserInKeycloak(String email, String password) {
        return Mono.fromCallable(() -> {
            UserRepresentation user = new UserRepresentation();
            user.setEnabled(true);
            user.setUsername(email);
            user.setEmail(email);
            user.setFirstName("TEST_FN");
            user.setLastName("TEST_LN");
